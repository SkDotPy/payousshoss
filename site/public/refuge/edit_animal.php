        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <form action="/backend/animals/update.php" method="POST" enctype="multipart/form-data" id="editAnimalForm">
              ...
              <!-- Santé & Vaccination -->
              <h5 class="mb-3"><i class="fas fa-heartbeat me-2"></i> Santé & Vaccination</h5>
              <div class="row g-3 mb-4">
                <div class="col-md-6">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="vaccinated" id="vaccinated" value="1" 
                           <?= !empty($animal['vaccinated']) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="vaccinated">
                      <i class="fas fa-syringe me-1"></i> Vacciné
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="sterilized" id="sterilized" value="1"
                           <?= !empty($animal['sterilized']) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="sterilized">
                      <i class="fas fa-cut me-1"></i> Stérilisé
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="good_with_kids" id="good_with_kids" value="1"
                           <?= !empty($animal['good_with_kids']) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="good_with_kids">
                      <i class="fas fa-child me-1"></i> Sociable avec les enfants
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="good_with_animals" id="good_with_animals" value="1"
                           <?= !empty($animal['good_with_animals']) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="good_with_animals">
                      <i class="fas fa-paw me-1"></i> Sociable avec les autres animaux
                    </label>
                  </div>
                </div>
              </div>
